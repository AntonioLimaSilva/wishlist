...
public class FindProductWishlistUseCaseTestEntity {

    WishlistRepository wishlistRepository;
    WishGateway wishGateway;
    FindProductWishlistUseCase findUseCase;

    public FindProductWishlistUseCaseTestEntity() {
    ...
    public WishlistEntity inputAddWishlistDtoMock() {
        ...
        input.setCustomerEntity(customer);
        input.setProductEntities(List.of(product));
        return input;
    }
}
